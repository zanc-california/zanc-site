    ...
    <footer className="bg-zambia-green text-white border-t border-zambia-green-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="py-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div>
            <h3 className="font-heading font-semibold text-white mb-3">Stay Connected</h3>
            <p className="text-sm text-white/80 max-w-xs">
              The fastest way to hear about events, opportunities, and community updates is through the ZANC email list.
            </p>
            <div className="mt-4 flex items-center gap-4">
              <a
                href="https://www.facebook.com/profile.php?id=100064323623986"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="ZANC Facebook"
              ...
              <a
                href="https://www.instagram.com/zanc916/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="ZANC Instagram"
                className="text-white/80 hover:text-copper transition-colors"
              >
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div className="mt-4">
              <Link to="/contact" className="text-copper hover:text-copper-glow transition-colors text-sm font-medium">
                Contact ZANC →
              </Link>
            </div>
          </div>
